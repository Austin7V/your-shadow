    ...
    return (
        <div className="mx-auto w-full max-w-6xl">
            <header className="mb-8">
                ...
                <p className="mt-3 max-w-2xl leading-7 text-muted-foreground">
                    Review your personal information, update your goals and
                    keep your health and weight data current.
                </p>
            </header>
        ...
        <span className="font-semibold text-foreground">
          Important:
                ...
                Your Shadow supports everyday wellness. It does not diagnose
                medical conditions, provide treatment or replace a qualified
